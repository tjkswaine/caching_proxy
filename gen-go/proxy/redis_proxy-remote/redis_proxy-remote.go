...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  bool initialize(ProxyConfig config)")
...
func main() {
  ...
  client := proxy.NewRedisProxyClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "initialize":
    ...
    argvalue0 := proxy.NewProxyConfig()
